    ...
    char* argv[])
{
    ...
    outdata.open("result_propose_1.txt"); // opens the file
    if (!outdata) { // file couldn't be opened
        cerr << "Error: file could not be opened" << endl;
        exit(1);
        
    }
    outdata << "RC\tMax\tVP\tTV\tTime_use" << endl;
    ...
    try {
        ...
        for (int m = 0; m < 15; m++)
        {
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 5; k++)
                {
                    CT1 += w_mn[m][n] * Q_nk[k] * (x_nk[n][k] + y_mnk[m][n][k]);
                }
            }
        }
        ...
        for (int m = 0; m < 15; m++)
        {
            for (int n = 0; n < 24; n++)
            {
                s = "c";
                s += to_string(count);
                model.addConstr(x_nk[n][0] + y_mnk[m][n][0] == 1, s);
                count++;
            }
        }
        ...
        for (int m = 0; m < 15; m++)
        {
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 4; k++)
                {
                    s = "c";
                    s += to_string(count);
                    model.addConstr(x_nk[n][k] + y_mnk[m][n][k] - x_nk[n][k + 1] - y_mnk[m][n][k + 1] >= 0, s);
                    count++;
                }
            }
        }
        ...
        for (int n = 0; n < 24; n++)
        {
            for (int k = 0; k < 5; k++)
            {
                cout << x_nk[n][k].get(GRB_StringAttr_VarName) << "=" << x_nk[n][k].get(GRB_DoubleAttr_X) << endl;
            }
        }
        for (int m = 0; m < 15; m++)
        {
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 5; k++)
                {
                    cout << y_mnk[m][n][k].get(GRB_StringAttr_VarName) << "=" << y_mnk[m][n][k].get(GRB_DoubleAttr_X) << endl;
                }
            }
        }
        */
        ...
        for (int m = 0; m < 15; m++)
        {
            for (int n = 0; n < 24; n++)
            {
                ...
                for (int k = 0; k < 5; k++)
                {
                    V_mn[m][n] += (x_nk[n][k].get(GRB_DoubleAttr_X) + y_mnk[m][n][k].get(GRB_DoubleAttr_X));
                }
        ...
        double end = clock();  // lấy thời gian sau khi thực hiện 
