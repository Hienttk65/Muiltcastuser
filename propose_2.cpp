...
double R[20] = { 50000,60000,70000,80000,90000,100000,110000,120000,150000,200000,250000,300000,350000,400000,450000,500000,550000,600000,650000,700000 };
//double p_m[15] = { 0.032, 0.039, 0.045, 0.051, 0.058 ,0.064, 0.077, 0.090 ,0.103 ,0.116, 0.129, 0.161, 0.193,0.225, 0.257 };
//double R[20] = {50000,60000,70000,80000,90000,100000,120000,140000,160000,180000,200000,250000,300000,350000,400000,450000,500000,550000,600000,650000 };

//double p_m[15] = { 0.012, 0.026, 0.039, 0.051, 0.064 ,0.077, 0.09, 0.103, 0.116 , 0.129, 0.154, 0.180, 0.206, 0.231, 0.257 };
...
//Rollercoaster
//double R[20] = { 70000,80000,90000,100000,110000,120000,150000,200000,250000,300000,350000,400000 };
//Diving
//double R[20] = { 200000,250000,300000,350000,400000,450000,500000,550000,600000,650000,700000 };
//Venice
//double R[20] = { 80000,90000,100000,110000,120000,150000,200000,250000,300000,350000,400000,450000,500000 };
int K_mn[15][24];
clock_t start, end;   
double time_use;
    ...
    char* argv[])
{
    ...
    outdata.open("result_propose_2.txt"); // opens the file
    if (!outdata) { // file couldn't be opened
        cerr << "Error: file could not be opened" << endl;
        exit(1);
    }
    outdata << "RC\tMax\tVP\tTV\tTime_User" << endl;
    ...
    for (int i = 0; i < 20;i++)
    {
        try {
            ...
            env.set("LogFile", "Hung_propose_2.log");
            env.start();
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    for (int k = 0; k < 5; k++)
                    {
                        s = name_z;
                        s += to_string(count);
                        z_mnk[m][n][k] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY, s);
                        count++;
                    }
                }
            }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    for (int k = 0; k < 5; k++)
                    {
                        CT1 += w_mn[m][n] * Q_nk[k] * y_mnk[m][n][k];
                    }
                }
            }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    for (int k = 0; k < 5; k++)
                    {
                        CT2 += (y_mnk[m][n][k] - z_mnk[m][n][k]) * (B_nk[k] / p_m[m]);
                    }
                }
            }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    s = "c";
                    s += to_string(count);
                    model.addConstr(y_mnk[m][n][0] == 1, s);
                    count++;
                }
            }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    for (int k = 0; k < 4; k++)
                    {
                        s = "c";
                        s += to_string(count);
                        model.addConstr(y_mnk[m][n][k] - y_mnk[m][n][k + 1] >= 0, s);
                        count++;
                    }
                }
            }
            ...
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 5; k++)
                {
                    for (int m = 0; m < 14; m++)
                    {
                        s = "c";
                        s += to_string(count);
                        model.addConstr(y_mnk[m][n][k] - y_mnk[m + 1][n][k] <= 0, s);
                        count++;
                    }
                }
            }
            ...
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 5; k++)
                {
                    s = "c";
                    s += to_string(count);
                    model.addConstr(z_mnk[0][n][k] == 0, s);
                    count++;
                }
            }
            for (int n = 0; n < 24; n++)
            {
                for (int k = 0; k < 5; k++)
                {
                    for (int m = 0; m < 14; m++)
                    {
                        s = "c";
                        s += to_string(count);
                        model.addConstr(z_mnk[m + 1][n][k] - y_mnk[m][n][k] == 0, s);
                        count++;
                    }
                }
            }
            ...
            //     for (int k = 0; k < 5; k++)
            //     {
            //         cout  << x_nk[n][k].get(GRB_DoubleAttr_X) << "," ;
            //     }
            // }
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    for (int k = 0; k < 5; k++)
                    {
                        cout << y_mnk[m][n][k].get(GRB_DoubleAttr_X) << ",";
                    }
                }
            }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    ...
                    for (int k = 0; k < 5; k++)
                    {
                        V_mn[m][n] += y_mnk[m][n][k].get(GRB_DoubleAttr_X);
                    }
                    VQ = VQ + (w_mn[m][n] * Q_nk[V_mn[m][n] - 1]);
                }
            ...
            for (int m = 0; m < 15; m++)
            {
                for (int n = 0; n < 24; n++)
                {
                    ...
                    for (int k = 0; k < 5; k++)
                    {
                        K_mn[m][n] += y_mnk[m][n][k].get(GRB_DoubleAttr_X);
                    }
            ...
            cout << "R" << R[i] << ",Obj: " << model.get(GRB_DoubleAttr_ObjVal) << ",VQ: " << VQ << ",TV: " << TV << ",Time_Use: " << time_use << endl;

            outdata << R[i] << "\t" << model.get(GRB_DoubleAttr_ObjVal) << "\t" << VQ << "\t" << TV << "\t" << time_use << endl;
